#!/usr/bin/env python3
"""Create release-ready NNEDI3CL zip and wheel assets."""
...
DEFAULT_ZIP_NAME = "nnedi3cl-msys2-ucrt64.zip"
...
def main(argv: list[str]) -> int:
    parser = argparse.ArgumentParser(description="Create release-ready NNEDI3CL zip and wheel assets.")
    parser.add_argument("--package-dir", default="dist/msys2-ucrt64/nnedi3cl", help="Built plugin package directory.")
